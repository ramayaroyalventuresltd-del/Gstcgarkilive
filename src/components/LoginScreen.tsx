...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onOpenScratchChecker }) => {
  const { login, loginWithGoogle, quickDemoLogin, language, setLanguage, t, isRTL } = useAuth();
      ...
      <main className="w-full max-w-[420px] bg-white border border-[#E5E0D3] rounded-2xl shadow-sm p-6 sm:p-8 my-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div className="relative flex py-1 items-center">
            ...
            <span className="flex-shrink mx-3 text-[11px] text-stone-400 font-medium uppercase">or</span>
            <div className="flex-grow border-t border-stone-200"></div>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-2.5 px-4 bg-white hover:bg-stone-50 border border-stone-300 text-stone-700 font-semibold text-xs rounded-lg shadow-2xs transition flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-70 focus:outline-none focus:ring-2 focus:ring-stone-400"
          >
